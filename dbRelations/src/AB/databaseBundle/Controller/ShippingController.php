...
use AB\databaseBundle\Entity\Shipping;
use AB\databaseBundle\Form\ShippingType;
...
class ShippingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ABdatabaseBundle:Shipping')->findAll();
     ...
     * @Method("POST")
     * @Template("ABdatabaseBundle:Shipping:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ABdatabaseBundle:Shipping')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ABdatabaseBundle:Shipping:edit.html.twig")
     */
