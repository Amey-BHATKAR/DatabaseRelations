...
use AB\databaseBundle\Entity\Student;
use AB\databaseBundle\Form\StudentType;
...
class StudentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ABdatabaseBundle:Student')->findAll();
     ...
     * @Method("POST")
     * @Template("ABdatabaseBundle:Student:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ABdatabaseBundle:Student')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ABdatabaseBundle:Student:edit.html.twig")
     */
