...
use AB\databaseBundle\Entity\Cart;
use AB\databaseBundle\Form\CartType;
...
class CartController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ABdatabaseBundle:Cart')->findAll();
     ...
     * @Method("POST")
     * @Template("ABdatabaseBundle:Cart:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ABdatabaseBundle:Cart')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ABdatabaseBundle:Cart:edit.html.twig")
     */
