...
use AB\databaseBundle\Entity\Customer;
use AB\databaseBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ABdatabaseBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("ABdatabaseBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ABdatabaseBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ABdatabaseBundle:Customer:edit.html.twig")
     */
