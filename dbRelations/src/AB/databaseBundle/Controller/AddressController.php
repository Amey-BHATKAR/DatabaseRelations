...
use AB\databaseBundle\Form\AddressType;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ABdatabaseBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("ABdatabaseBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ABdatabaseBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ABdatabaseBundle:Address:edit.html.twig")
     */
