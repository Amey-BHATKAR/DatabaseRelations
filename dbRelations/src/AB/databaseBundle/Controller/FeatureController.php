...
use AB\databaseBundle\Entity\Feature;
use AB\databaseBundle\Form\FeatureType;
...
class FeatureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ABdatabaseBundle:Feature')->findAll();
     ...
     * @Method("POST")
     * @Template("ABdatabaseBundle:Feature:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ABdatabaseBundle:Feature')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ABdatabaseBundle:Feature:edit.html.twig")
     */
